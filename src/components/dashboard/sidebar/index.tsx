  ...
  return (
    <TooltipProvider delayDuration={0}>
      ...
      >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full justify-start px-2 hover:bg-white/40 h-10 gap-2 rounded-xl text-slate-800">
                  <div className="h-7 w-7 rounded-lg bg-[#1e293b] flex items-center justify-center text-white font-bold shrink-0 shadow-lg shadow-indigo-500/10">
                    {workspace.initial}
                  </div>
          ...
          {isCollapsed ? (
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-9 pl-9 pr-10 rounded-xl bg-white/50 border border-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 placeholder:text-slate-400/50 hover:bg-white/60 transition-colors"
              />
        ...
        {/* Navigation */}
        <nav className="flex-1 overflow-y-auto overflow-x-hidden px-3 py-2 space-y-2 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent" aria-label="Dashboard navigation">
                ...
                {group.items.map((item) => {
                  ...
                  const linkContent = (
                    <Link
                      ...
                      className={cn(
                        "flex items-center gap-3 px-3 py-1.5 rounded-2xl text-sm font-medium transition-all duration-200 group relative",
                        isActive
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className={cn(
                  "w-full justify-start h-auto hover:bg-white/40 rounded-2xl",
